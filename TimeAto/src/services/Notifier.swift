...
let kActionCategory = "ACTIONS_CATEGORY"
let kStartNextAction = "START_NEXT_ACTION"
...
extension Notifier: UNUserNotificationCenterDelegate {
    ...
    func defineActionCategory() {
        let startNextAction = UNNotificationAction(
            identifier: kStartNextAction,
            title: "Start Next Task"
        )
        
        let category = UNNotificationCategory(
            identifier: kActionCategory,
